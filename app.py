...
cursor.execute("CREATE TABLE IF NOT EXISTS production_records (id INT(11) NOT NULL AUTO_INCREMENT, product_name VARCHAR(255), factory_worker VARCHAR(255), product_quantity INT, production_date DATE, PRIMARY KEY(id))")
